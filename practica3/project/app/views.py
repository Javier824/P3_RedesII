...
# Ruta base donde se encuentran los los actores
ACTORS_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "actors"))

def _python():
    # Devuelve ejecutable python para ejecutar subprocesos
...
class SensorCreateView(CreateView):
    ...
    def form_valid(self, form):
        # Asignamos el tipo de dispotivo
        form.instance.device_type = 'sensor'
        response = super().form_valid(form)
        d = self.object
        
        # Lanzamos el script para iniciar el dispositivo
...
class DeviceUpdateView(UpdateView):
    ...
    def get_form(self, form_class=None):
        ...
        # Añadimos a la lista de permitidos los campos específicos según el tipo
        ...
        # Borramos del formulario los campos que no correspondan a este tipo
